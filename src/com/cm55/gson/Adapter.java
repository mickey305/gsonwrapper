...
public class  Adapter<T> {
  ...
  /** クラスを指定する */
  public Adapter(Class<T>targetClass) {
   ...
   * @param targetToken
   */
  public Adapter(TypeToken<T>targetToken) {
   ...
   */
  public Adapter<T> addSubAdapter(Adapter<?> subAdapter) {
    if (subAdapters == null) subAdapters = new ArrayList<Adapter<?>>();
    subAdapters.add(subAdapter);
    return this;
  }

  public Adapter<T>addSubAdapters(Adapter<?>...subAdapters) {
